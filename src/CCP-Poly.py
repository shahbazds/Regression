...
#Transformation and Regressioin with Degree-4
...
lin_reg.fit(X_train_poly,y_train)
y_pred1 = lin_reg.predict(X_test_poly)
print("Polynomial Regression Score with Degree-4 : ",lin_reg.score(X_test_poly, y_test))
print("Polynomial Regression MSE with Degree-4 : ",mean_squared_error(y_test,y_pred1))
print("Polynomial Regression RMSE with Degree-4: ", sqrt(mean_squared_error(y_test,y_pred1)))

#Transformation and Regressioin with Degree-5
#Polynomial Degree-5 was selected on the bases of better results
...
lin_reg.fit(X_train_poly,y_train)
y_pred1 = lin_reg.predict(X_test_poly)
print("Polynomial Regression Score with Degree-5 : ",lin_reg.score(X_test_poly, y_test))
print("Polynomial Regression MSE with Degree-5 : ",mean_squared_error(y_test,y_pred1))
print("Polynomial Regression RMSE with Degree-5: ", sqrt(mean_squared_error(y_test,y_pred1)))
